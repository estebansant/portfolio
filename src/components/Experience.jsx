...
const Experience = () => {
  ...
  return (
    <section
      id="experience" 
      className="w-full h-auto mt-5 overflow-hidden px-6 md:mt-10 md:px-[50px] special:px-[125px] lg:px-[17.5%] xl:px-[20%]"
    >
      <motion.div
        variants={experienceScreen}
        initial="offscreen"
