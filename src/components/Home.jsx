...
const Home = () => {
  return (
    <section id="home" className="w-full h-screen flex flex-col justify-around relative overflow-hidden md:h-[65vh]special:h-[75vh]">
      ...
      <img src={desktop} alt="desktop with computer" className="w-[85%] h-auto absolute bottom-[20%] -right-[10%] z-10 md:w-[52%] md:right-[8%] md:bottom-[18%] special:w-[36%] special:right-[8%] special:bottom-[22%] lg:w-[35%] lg:bottom-[17%] lg:right-[15%]"/>

      <div className="w-full z-10 pt-6 px-6 md:px-8 md:pt-8 lg:px-[175px] lg:w-[75%] lg:pt-16">
