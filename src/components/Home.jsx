...
const Home = () => {
  return (
    <section id="home" className="w-full h-screen flex flex-col justify-around relative overflow-hidden md:h-[65vh">
      ...
      <img src={desktop} alt="desktop with computer" className="w-[85%] h-auto absolute bottom-[20%] -right-[10%] z-10 transition transition-all duration-300 ease-in-out hover:scale-110 md:w-[52%] md:right-[8%] md:bottom-[18%] special:w-[36%] special:right-[8%] special:bottom-[22%]"/>
