...
const Contact = () => {
  return (
    <section id="contact" className="w-full h-auto px-6 mt-8 md:mt-10 md:px-[50px] special:px-[125px] lg:px-[17.5%] xl:px-[20%]">
      ...
      <form
        ...
        className="w-full h-auto border-solid border-2 border-black rounded-md p-6 flex flex-col items-center md:w-[70%] md:m-auto special:w-[60%] lg:w-[48%] xl:w-[37%]"
      >
        {/* Hidden fields */}
